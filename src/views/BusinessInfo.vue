<template>
  <div class="wrapper">
    ...
    <ul class="food">
      <li v-for="(item,index) in foodArr">
        ...
        <div class="food-right">
          <div>
            <i v-show="item.quantity!=0" class="fa fa-minus-circle" @click="minus(index)"></i>
          </div>
    ...
    <div class="cart">
      <div class="cart-left">
        <div :style="totalQuantity==0?'background-color:#505051;':'background-color:#3190E8;'" class="cart-left-icon">
          <i class="fa fa-shopping-cart"></i>
          <div v-show="totalQuantity!=0" class="cart-left-icon-quantity">{{ totalQuantity }}</div>
        </div>
      ...
      <div class="cart-right">
        ...
        <!-- 达到起送费 -->
        <div v-show="totalSettle>=business.starPrice" class="cart-right-item" @click="toOrder">
          去结算
        </div>
      </div>
    </div>
